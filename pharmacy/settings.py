...
SECRET_KEY = os.environ.get("SECRET_KEY", default='django-insecure-!z4_r*)k-uz182il8xhttz($9%b^(1_1suyravkuk2%gj(slhu')
...
RENDER_EXTERNAL_HOSTNAME =  "https://" + os.environ.get("RENDER_EXTERNAL_HOSTNAME")
